...
package fiftyone.pipeline.setheader;

public class Constants {
	/**
	 * The element data key of the {@link SetHeaderElement}.
	 */
	public static final String SET_HEADER_ELEMENT_DATAKEY = "set-headers";
	
	/**
	 * The element data key of the Device Detection engine.
	 */
	public static final String DEVICE_ELEMENT_DATAKEY = "device";
	...
	/**
	 * The single property name of the {@link SetHeaderElement}.
	 */
